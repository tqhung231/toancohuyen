  ...
  return (
    <div className="group bg-white rounded-xl shadow-sm border border-slate-200 p-4 grid grid-cols-1 md:grid-cols-[72px_minmax(0,1fr)_150px_150px_110px_44px] gap-4 md:gap-3 md:items-center transition-all duration-200 hover:shadow-md hover:border-indigo-100">
      ...
      <div className="col-span-full md:col-span-1 flex flex-col gap-2 md:items-center md:justify-self-center">
        ...
        <div className="flex items-center bg-white rounded-lg border border-emerald-400 overflow-hidden w-full md:w-[150px]">
          <button
      ...
      <div className="col-span-full md:col-span-1 flex flex-col gap-2 md:items-center md:justify-self-center">
        ...
        <div className="flex items-center bg-white rounded-lg border border-rose-400 overflow-hidden w-full md:w-[150px]">
          <button
